...
const translations = {
    it: {
        ...
        'menu.intro.downloadButton': 'Scarica Menu in Italiano',
        'menu.intro.scrollNote': '(Scorri in fondo per il menu in altre lingue)',
        ...
        'menu.cta.title': 'Scopri il Menu in Altre Lingue',
        'menu.cta.body': 'Visualizza il nostro menu completo in Italiano, English, Français, Deutsch e Nederlands',
        'menu.cta.button': 'Visualizza Menu Multilingue',
    ...
    en: {
        ...
        'menu.intro.downloadButton': 'Download Menu in Italian',
        'menu.intro.scrollNote': '(Scroll down for the menu in other languages)',
        ...
        'menu.cta.title': 'Discover the Menu in Other Languages',
        'menu.cta.body': 'View our complete menu in Italiano, English, Français, Deutsch and Nederlands',
        'menu.cta.button': 'View Multilingual Menu',
